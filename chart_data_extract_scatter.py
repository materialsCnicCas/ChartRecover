...
from correct_coordinates_scatter import correct_coordinates_scatter
import warnings
...
def Scatter_detection(img_path, result_main_folder):
    ...
    for img_file in img_files:
        ...
        if not os.path.exists(f'{result_folder_path}/Scatter_result'):
            os.makedirs(f'{result_folder_path}/Scatter_result')
        ...
        with open(f"{result_folder_path}/Scatter_result/scatter_boxes.json", "w") as f:
...
def TrOCR(img_path, result_main_folder):
    ...
    for img_file in img_files:
        ...
        correct_coordinates_scatter(result_folder_path)
