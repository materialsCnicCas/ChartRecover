...
element_train_PMC  = dict(
    type='CocoDataset',
    data_root=data_root,
    ann_file='element_PMC/train.json',
    data_prefix=dict(img='element_PMC/train/'),
    pipeline=train_pipeline,
    backend_args=None,
    metainfo=metainfo,
    filter_cfg=dict(filter_empty_gt=False, min_size=32),)

element_test_PMC = dict(
    type='CocoDataset',
    data_root=data_root,
    ann_file='element_PMC/test.json',
    data_prefix=dict(img='element_PMC/test/'),
...
test_evaluator = dict(
    _scope_='mmdet',
    ann_file='/home/yuanyang/data_extract/data/PMC_Adobe_coco_data/element_PMC/test.json',
    backend_args=None,
    format_only=False,
    classwise=True,
    metric='bbox',
...
work_dir = './work_dirs/co_detr/co_detr_elementv2'
