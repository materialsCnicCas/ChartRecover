...
scatter_train_PMC  = dict(
    type='CocoDataset',
    data_root=data_root,
    ann_file='scatter_PMC/train.json',
    data_prefix=dict(img='scatter_PMC/train/'),
    pipeline=train_pipeline,
    backend_args=None,
    metainfo=metainfo,
    filter_cfg=dict(filter_empty_gt=False, min_size=32),)

scatter_train_adobe = dict(
    type='CocoDataset',
    data_root=data_root,
    ann_file='scatter_adobe/train.json',
    data_prefix=dict(img='scatter_adobe/train/'),
    pipeline=train_pipeline,
    backend_args=None,
    metainfo=metainfo,
    filter_cfg=dict(filter_empty_gt=False, min_size=32),)

scatter_test_PMC = dict(
    type='CocoDataset',
    data_root=data_root,
    ann_file='scatter_PMC/test.json',
    data_prefix=dict(img='scatter_PMC/test/'),
    pipeline=test_pipeline,
    metainfo=metainfo,
    backend_args=None,
    test_mode=True,)

scatter_test_adobe = dict(
    type='CocoDataset',
    data_root=data_root,
    ann_file='scatter_adobe/test.json',
    data_prefix=dict(img='scatter_adobe/test/'),
    pipeline=test_pipeline,
    metainfo=metainfo,
    backend_args=None,
    test_mode=True,)
...
train_dataset = dict(
    type='ConcatDataset',
    datasets=[scatter_train_PMC, scatter_train_adobe])

test_cfg = dict(_scope_='mmdet', type='TestLoop')
test_dataloader = dict(
    batch_size=1,
    dataset=scatter_test_PMC,
    drop_last=False,
    num_workers=2,
...
test_evaluator = dict(
    _scope_='mmdet',
    ann_file='/home/yuanyang/data_extract/data/PMC_Adobe_coco_data/scatter_PMC/test.json',
    backend_args=None,
    format_only=False,
    classwise=True,
    metric='bbox',
...
work_dir = './work_dirs/co_detr/co_detr_scatterv2'
